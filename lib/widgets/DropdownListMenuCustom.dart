...
const double kDropdownMenuItemHeightCustom = 45.0;

class DropdownListMenuCustom<T> extends DropdownWidget {
  final List<T> data;
  final int selectedIndex;
  final MenuItemBuilder itemBuilder;
  final double itemExtent;

  DropdownListMenuCustom(
      {this.data,
      this.selectedIndex,
      this.itemBuilder,
      this.itemExtent: kDropdownMenuItemHeightCustom});
...
class _MenuListState<T> extends DropdownState<DropdownListMenuCustom<T>> {
  int _selectedIndex;
...
class DropdownTreeMenu<T, E> extends DropdownWidget {
  ...
  DropdownTreeMenu({
    ...
    this.subSelectedIndex,
        ...
        itemExtent = itemExtent ?? kDropdownMenuItemHeightCustom;
