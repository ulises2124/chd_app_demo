class PedidoEnvioDTO {
  ...
  factory PedidoEnvioDTO.fromJson(Map<String, dynamic> json) {
    var _consignment = json['consignments'] as List;
    var _deliveryOrderGroup = json['deliveryOrderGroups'] as List;
    ...
    List<Consignment> _consignmentList =
        _consignment.map((i) => Consignment.fromJson(i)).toList();
    List<DeliveryOrderGroup> _deliveryOrderGroups =
        _deliveryOrderGroup.map((i) => DeliveryOrderGroup.fromJson(i)).toList();
...
class DeliveryMode {
  ...
  factory DeliveryMode.fromJson(Map<String, dynamic> json) {
    if (json == null) {
      return DeliveryMode(code: null, description: null, name: null);
    } else {
      return DeliveryMode(
          code: json['code'],
...
class Product {
  ...
  factory Product.fromJson(Map<String, dynamic> json) {
    ...
    if (_categoryList != null) {
      _categories = _categoryList.map((i) => Category.fromJson(i)).toList();
    }
    var _imageList = json['images'] as List;
    List<ProductReference> _productReferences;
    if (json['productReferences'] != null) {
      var _productReferenceList = json['productReferences'] as List;
      _productReferences = _productReferenceList
          .map((i) => ProductReference.fromJson(i))
          .toList();
    } else {
      _productReferences = [];
    }

    List<Image> _images = _imageList.map((i) => Image.fromJson(i)).toList();
    return Product(
        ...
        name: json['name'],
        productReferences: _productReferences,
...
class Category {
  ...
  factory Category.fromJson(Map<String, dynamic> json) {
    if (json == null) {
      return Category(code: null, url: null);
    } else {
  ...
  factory ProductReference.fromJson(Map<String, dynamic> json) {
    if (json == null) {
      return ProductReference(
          referenceType: null, target: null, preselected: null);
    } else {
      return ProductReference(
...
class Unit {
  ...
  factory Unit.fromJson(Map<String, dynamic> json) {
    if (json == null) {
      return Unit(
        code: null, conversion: null, name: null);
    } else {
    }
    return Unit(
...
class Consignment {
  ...
  factory Consignment.fromJson(Map<String, dynamic> json) {
    var _orderEntry = json['entries'] as List;
    List<OrderEntry> _orderEntryList =
        _orderEntry.map((i) => OrderEntry.fromJson(i)).toList();
    return Consignment(
        code: json['code'],
        entries: _orderEntryList,
