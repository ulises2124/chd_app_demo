...
class CardUtils {
  ...
  static String validateCVVAmex(String value) {
    if (value.isEmpty) {
      return Strings.fieldReq;
    }
  ...
  static String validateDate(String value) {
    ...
    if ((fourDigitsYear < 1) || (fourDigitsYear > 2099)) {
      ...
      return 'Año de caducidad invalido';
    }
...
class Strings {
  ...
  static const String numberIsInvalid = 'Número de tarjeta invalido';
}