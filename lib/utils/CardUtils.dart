...
class Strings {
  static const String fieldReq = 'Por favor rellene este campo';
  static const String numberIsInvalid = 'Número de tarjeta no valido';
}
...
class CardUtils {
  ...
  static String validateDate(String value) {
    ...
    if ((month < 1) || (month > 12)) {
      ...
      return 'Mes de expiración no valido';
    }
    ...
    if ((fourDigitsYear < 1) || (fourDigitsYear > 2099)) {
      ...
      return 'Año de expiración no valido';
    }
  ...
  static String getCardTypeFrmNumber(String input) {
    ...
    else if (input.startsWith(new RegExp(r'(506)'))) {
      cardType = "Carnet";
